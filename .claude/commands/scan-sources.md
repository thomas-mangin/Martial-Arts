# Scan Sources - Monitor Blogger Content for Ideas

You are helping the user monitor tracked martial arts bloggers for new content and extract ideas for blog posts.
...
#### Idea 2: [Proposed Title]
- **Type**: Alternative Perspective
- **Angle**: [Different way to view it]
- **Connection**: [Link to source post]
- **Your Perspective**: [Your angle]
- **Aikido Relevance**: [Connection to your practice]
- **Estimated Depth**: 800-1000 words
...
## Post 2: [Title]
[Repeat format for each new post]

---

## Post 3: [Title]
[Continue for all new posts found]
...
- Theme 1: [Pattern across posts]
- Theme 2: [Evolving discussion]
- Connection: [How posts relate to each other]
...
- [ ] [Idea 3 - ready to add to topics.md]

### Further Research
- [ ] [Topic needing more investigation before writing]
- [ ] [Claim to verify]
- [ ] [Technique to study more]

### Future Consideration
- [ ] [Ideas to revisit later]
- [ ] [Topics for long-term development]
...
- [Connections to your previous work]
...
**Blog Formats**:
- WordPress, Blogger, custom sites all different
- Some show excerpts, some full posts
- Some have clear dates, others don't
- Adapt prompt to what's visible

**Language**:
- Primary focus: blogs user can read
- French blogs: User mentioned Lionel Froidure, so French OK
- If translation needed, note it
- Multi-language blogs: focus on user's languages

**Access Issues**:
- Some blogs may block scraping
- Some require login
- Some have paywalls
- If can't access: note it, suggest manual review
...
[Findings generated]
      ↓
User: /discuss [inspired topic]
      ↓
User: /extract discussions/[file].md
      ↓
User: /review-aikido posts/[file].md
      ↓
User: /checkpoint
```

### Discovery → Direct Writing
...
### Good Findings Report
- Clear summaries of posts
- Accurate representation of arguments
- Diverse, actionable ideas
- Specific connections to Aikido
- Respectful tone
- Ready to act on

### Great Findings Report
- Identifies subtle nuances
- Sees connections not obvious
- Generates surprising angles
- Shows deep understanding
- Sparks genuine interest
- Makes user want to write immediately
...
*After scanning, user can explore ideas with `/discuss`, add to `topics.md`, or write directly*
